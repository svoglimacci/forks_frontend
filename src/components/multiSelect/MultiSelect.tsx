  ...
  return (
    <div className={cn("w-full", className)}>
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger
          className={cn(
            "flex  w-full transition-all items-center justify-between rounded-md border border-input bg-background text-sm",
        ...
        >
          <div className="flex justify-between flex-1">
            <div className="flex gap-1 flex-1 py-2 px-3 flex-wrap">
              {value.length === 0 ? (
